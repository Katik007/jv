...
public class Mage extends Player implements Caster {
    ...
    public Mage(int health, String name, int posX, int posY, int damage, int defense) {
    ...
    public void castSpell(Player player) {
        if (!isAlive) {
            System.out.println(name + " не может атаковать, тк мертв");
            return;
        }
        System.out.println(name + " кинул атакующее заклинание в " + player.name + " с уроном " + damage);
